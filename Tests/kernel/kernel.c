...
#include <stdint.h>
#include <math.h>
#include "kernelworld.h"

void exports_planner_kernelworld_plan_grayscale(exports_planner_kernelworld_plan_imagedata_t *img, exports_planner_kernelworld_plan_imagedata_t *ret){
...
void exports_planner_kernelworld_plan_invert(exports_planner_kernelworld_plan_imagedata_t *img, exports_planner_kernelworld_plan_imagedata_t *ret) {
    uint8_t *data = img->pixels.ptr;
    uint32_t width = img->width;
    uint32_t height = img->height;
...
void exports_planner_kernelworld_plan_sobel(exports_planner_kernelworld_plan_imagedata_t *img, exports_planner_kernelworld_plan_imagedata_t *ret){
